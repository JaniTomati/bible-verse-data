...
def download_txt(document_url, out_name):
    ...
    print(f"Downloading text from {document_url}.")
...
def lexical_novelty(data): 
    ...
    book_id = "b_1"
    for text_info in data: 
        if text_info["book_id"] != book_id: # clear seen words for every book
            seen_words = []
            book_id = text_info["book_id"]
...
def main():
    ...
    with open(out_name) as f:
        ...
        write_testament([old_books, new_books], [old_testament, new_testament], ["old", "new"], "verses") # tokenize into verses 
        # write_testament([old_books, new_books], [old_testament, new_testament], ["old", "new"], "sentences") # tokenize into sentences
